...
const About: React.FC = () => (
  <div className="max-w-4xl mx-auto px-4 py-8">
    <h1 className="text-3xl font-bold mb-6">About TalentVault</h1>
    <div className="prose dark:prose-invert">
      <p>TalentVault is an AI-powered talent discovery platform designed to help aspiring performers showcase their talents and connect with entertainment industry professionals.</p>
      <h2>Our Mission</h2>
